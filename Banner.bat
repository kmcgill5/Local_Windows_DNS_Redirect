...
cls
echo [96m=======================================================================================================================
echo [95m                                                    Website Blocker
echo [96m=======================================================================================================================
echo [91m B: (Blocks)         [33mR: (Re-direct)         [94mE: (Enables)         [92mL: (Lists sites)         [97mC: (Clear)         [90mQ: (Quit)
echo.
echo [93mBans entire websites, not just games on that website (ex. bans YouTube.com, not only a certain video)
...
echo     If applicable, include the www
:Input
echo.[97m
...
if ERRORLEVEL 255 (
    ...
    "C:\Program Files\BlueJ\jdk\bin\java.exe" Enable !website!
    goto Input
    ...
    echo         !redirect! !website!>>C:\Users\student\Desktop\hosts
    goto Input
) else if ERRORLEVEL 1 (
    echo.[91m
    set /p website=What website do you want banned? 
